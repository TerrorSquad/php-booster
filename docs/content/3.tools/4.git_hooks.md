...
::callout{type="info"}
**Wildcards vs. Lists:**
Tools like `ESLint`, `Prettier`, and `Rector` automatically handle lists of files. For tools that run on the whole project, set `"passFiles": false`.
::
...
| Group | Tools |
|-------|-------|
| `lint` | ESLint, Stylelint, PHP Syntax Check, TypeScript, Markdownlint |

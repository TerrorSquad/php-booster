...
1. Add the Renovate bot as a project member
2. Configure CI/CD variables if needed
3. Renovate will start creating merge requests

### Self-Hosted

For self-hosted Renovate, refer to the [official documentation](https://docs.renovatebot.com/self-hosting/).
